...
type StructuredErrorCode =
  ...
  | "POST_DISABLED"
  | "ACCOUNT_RISK"
  | "CHECK_IN_ACCOUNT_RISK"
  | "CHECK_IN_TOPIC_CONFIG_INVALID"
  | "CHECK_IN_PLATFORM_REJECTED"
  | "CHECK_IN_NETWORK_FAILED"
  | "CONNECTIVITY_PLATFORM_BLOCKED"
  | "CONNECTIVITY_PROXY_ROUTE_FAILED"
  | "CONNECTIVITY_NETWORK_UNREACHABLE"
  | "TARGET_ISSUE"
  | "CONTENT_ISSUE"
  | "TRANSIENT_NETWORK"
  | "PLATFORM_BUSY"
...
const structuredReasonMap: Partial<Record<StructuredErrorCode, ExecutionErrorClass>> = {
  ...
  CHECK_IN_ACCOUNT_RISK: "ACCOUNT_RISK",
  CHECK_IN_TOPIC_CONFIG_INVALID: "TARGET_ISSUE",
  CHECK_IN_PLATFORM_REJECTED: "PLATFORM_BUSY",
  CHECK_IN_NETWORK_FAILED: "TRANSIENT_NETWORK",
  CONNECTIVITY_PLATFORM_BLOCKED: "PLATFORM_BUSY",
  CONNECTIVITY_PROXY_ROUTE_FAILED: "TRANSIENT_NETWORK",
  CONNECTIVITY_NETWORK_UNREACHABLE: "TRANSIENT_NETWORK",
