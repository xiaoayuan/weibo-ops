  ...
  return (
    <div className="space-y-6">
      ...
      <SurfaceCard className="grid gap-5 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          <h2 className="text-xl font-semibold text-app-text-strong">这一页已经切入新壳层</h2>
        ...
        <div className="rounded-[24px] border border-app-line bg-app-panel-strong/70 p-5">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-app-accent">迁移建议</p>
          <ul className="mt-4 space-y-3 text-sm text-app-text-muted">
            <li>先接入这个模块的列表读取接口。</li>
            <li>再迁移新增、编辑、删除和批量动作。</li>
            <li>最后补齐更细的状态反馈和空态文案。</li>
          </ul>
          <Link href="/" className="mt-6 inline-flex text-sm text-app-accent transition hover:text-app-text-strong">
            返回控制台查看整体进度
          </Link>
        </div>
      </SurfaceCard>
